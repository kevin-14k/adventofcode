...
func IntcodeProgram(noun int, verb int) ([]int) {
	return []int{1,noun,verb,3,1,1,2,3,1,3,4,3,1,5,0,3,2,10,1,19,1,5,19,23,1,23,5,27,2,27,10,31,
...
func main() {
	for noun := 0; noun < 100; noun++ {
		for verb := 0; verb < 100; verb++ {
			r := Process(IntcodeProgram(noun, verb))
